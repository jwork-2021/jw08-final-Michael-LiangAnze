...
public class WorldScreen implements Screen {
        ...
        try {
            ...
            for (int i = 0; i < mapSize; i++) {
                for (int j = 0; j < mapSize; j++) {
                    ...
                    // 9为帐篷
                    switch(tempMap[i][j]){
                        case 1:world.put(new MapItem(new Color(220,220,220),177,this.world), new Tuple<Integer,Integer>(i,j));break;
                        case 2:world.put(new MapItem(new Color(30,144,255),156,this.world), new Tuple<Integer,Integer>(i,j));break;
                        case 3:world.put(new MapItem(AsciiPanel.green,24,this.world), new Tuple<Integer,Integer>(i,j));break;
                        case 4:world.put(new MapItem(new Color(255,193,37),35,this.world), new Tuple<Integer,Integer>(i,j));break;
    ...
    public void gamingScreen() {
        ...
        Shooter shooter1 = new Shooter(1, 100, 1, world, map, player, cannonballList, 18, 1, 27, 10);
        Shooter shooter2 = new Shooter(1, 100, 1, world, map, player, cannonballList, 30, 8, 37, 10);
        Shooter shooter3 = new Shooter(1, 100, 1, world, map, player, cannonballList, 27, 18, 37, 21);

        SworksMan sworksMan1 = new SworksMan(1, 150, 8,1, 2, world, map,player,2,2,17,11);
        SworksMan sworksMan2 = new SworksMan(1, 150, 8,1, 2, world, map,player,31,1,38,6);
        SworksMan sworksMan3 = new SworksMan(1, 150, 9,1, 2, world, map,player,1,23,16,37);
        SworksMan sworksMan4 = new SworksMan(1, 150, 8,1, 2, world, map,player,24,24,36,37);
